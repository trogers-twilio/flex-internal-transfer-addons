...
The following describes how you setup, develop and deploy your Flex plugin.
...
In the `/public` directory make a copy of the `appConfig.example.js` file and rename it to `appConfig.js`.
...
In order to develop locally, you can use the Twilio CLI to run the plugin locally. Using your command line run the following from the root directory of the plugin.
